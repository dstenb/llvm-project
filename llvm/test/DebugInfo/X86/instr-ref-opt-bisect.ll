; RUN: llc %s -o - -stop-after=livedebugvalues -experimental-debug-variable-locations=true  -opt-bisect-limit=0 \
; RUN:   | FileCheck %s
; RUN: llc %s -o - -stop-after=livedebugvalues -experimental-debug-variable-locations=true -opt-bisect-limit=10 \
; RUN:   | FileCheck %s
; RUN: llc %s -o - -stop-after=livedebugvalues -experimental-debug-variable-locations=true -opt-bisect-limit=20 \
; RUN:   | FileCheck %s
; RUN: llc %s -o - -stop-after=livedebugvalues -experimental-debug-variable-locations=true -opt-bisect-limit=30 \
; RUN:   | FileCheck %s
; RUN: llc %s -o - -stop-after=livedebugvalues -experimental-debug-variable-locations=true -opt-bisect-limit=40 \
; RUN:   | FileCheck %s
; RUN: llc %s -o - -stop-after=livedebugvalues -experimental-debug-variable-locations=true -opt-bisect-limit=100 \
; RUN:   | FileCheck %s
;; Test fast-isel for good measure too,
; RUN: llc %s -o - -stop-after=livedebugvalues -experimental-debug-variable-locations=true -fast-isel=true \
; RUN:   | FileCheck %s
; RUN: llc %s -o - -stop-after=livedebugvalues -experimental-debug-variable-locations=true -fast-isel=true \
